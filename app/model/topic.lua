...
function topic_model:get_all(topic_type, category, search, page_no, page_size)
    ...
    local res, err = db:query("select t.id,t.title,t.user_id,t.user_name,t.like_num,t.collect_num,t.reply_num,t.follow,t.view_num,t.last_reply_id,t.last_reply_name,t.category_id,t.is_good,t.weight,t.last_reply_time,t.update_time,t.create_time, c.name as category_name, u.avatar as avatar from topic t " .. 
        " left join user u on t.user_id=u.id " ..
        " left join category c on t.category_id=c.id " ..
        " where " .. sqlwhere ..
...
function topic_model:get_all_of_user(user_id, page_no, page_size)
    ...
    local res, err = db:query("select t.id,t.title,t.user_id,t.user_name,t.like_num,t.collect_num,t.reply_num,t.follow,t.view_num,t.last_reply_id,t.last_reply_name,t.category_id,t.is_good,t.weight,t.last_reply_time,t.update_time,t.create_time," .. 
        " u.avatar as avatar, c.name as category_name  from topic t " .. 
        " left join user u on t.user_id=u.id " .. 
        " left join category c on t.category_id=c.id " ..
...
function topic_model:get_all_like_of_user(user_id, page_no, page_size)
    ...
    local res, err = db:query("select t.id,t.title,t.user_id,t.user_name,t.like_num,t.collect_num,t.reply_num,t.follow,t.view_num,t.last_reply_id,t.last_reply_name,t.category_id,t.is_good,t.weight,t.last_reply_time,t.update_time,t.create_time," .. 
        " u.avatar as avatar, c.name as category_name  from `like` l " .. 
