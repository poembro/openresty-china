(function(L) {
    ...
    _this = L.Index = {
        ...
        init: function(currentCategory, search) {
            _this.data.search = search || '';
            _this.data.currentCategory = currentCategory || '0';
        ...
        initEvents: function() {
            $(document).on('click', '#topic-type-tab a', function() {
                $('#topic-type-tab a').removeClass('active');
        ...
        loadTopics: function(type, pageNo) {
            ...
            $.ajax({
                ...
                data: {
                    page_no: 1,
                    type: type,
                    category: _this.data.currentCategory,
